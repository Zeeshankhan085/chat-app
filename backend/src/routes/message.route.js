...
import { getUsersForSideBar, getMessagesWithUser, sendMessage, receiveMessage } from '../controllers/message.controller.js';
...
router.post('/receive/:userId', protectRoutes, sendMessage)
